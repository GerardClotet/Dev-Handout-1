...
bool j1App::Awake()
{
	...
	if(config.empty() == false)
	{
		...
		framecap = framerate_cap.attribute("framerate_cap").as_int();
...
void j1App::FinishUpdate()
{
	...
	SDL_Delay(16.6f - last_frame_ms );
	// TODO3: Measure accurately the amount of time it SDL_Delay actually waits compared to what was expected
	

	LOG("We waitet %f miliseconds and got back in %f", last_frame_ms, delay_dif);
	//PERF_PEEK(Delaytimer);
}
