...
j1App::j1App(int argc, char* args[]) : argc(argc), args(args)
{
	...
	AddModule(render);
	LOG("time needed to execute constructors: %f ms", timer.ReadMs());
}
...
bool j1App::Awake()
{
	...
	LOG("time needed to awake :%i ms", timer.ReadMs());
...
bool j1App::Start()
{
	...
	LOG("time needed start app :%i ms", timer.ReadMs());
...
bool j1App::CleanUp()
{
	...
	LOG("time needed to clean up:%i ms", timer.ReadMs());
